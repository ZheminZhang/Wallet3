...
export default class GetBalance extends Component<Props> {
  ...
  render() {
    ...
    return (
      <View style={{height: 50,backgroundColor:'white',flex:1,marginLeft: 10,marginRight:10}}>
        <Text style={{fontSize:35,fontStyle:'normal',fontWeight:'900',marginLeft: 10}}>余额</Text>
        <View style={{flex:1, flexDirection:'row', justifyContent:'space-around'}}>
          <Text style={{fontSize:30,fontStyle:'normal',fontWeight:'900',marginLeft: 10}}>{balance}</Text>
          <View style = {{width:30, height:30}}><Button
            title='刷新'
